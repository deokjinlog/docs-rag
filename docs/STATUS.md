...
- **회사별 recall 스코어보드** — 새 문서 6개 유니크 급부 10문항(치매·장기요양·태아·영구치·LIG·배상책임 등). 유니크 급부 질의는 rank 1(KB치매·태아·라이나영구치 0.99+), 흔한 개념(상해·배상책임) 질의는 다른 회사 청크와 경쟁→앵커/질의 교정으로 보정. **교훈: 겹치는 코퍼스에선 질의·앵커 둘 다 유니크해야 doc-level recall 유효.**
