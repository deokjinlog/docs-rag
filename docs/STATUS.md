...
- **색인 완료 7문서** → **1339청크**(docs_rag_v1). 4회사(라이나·New치아·다이렉트·회사미상). 2026-08-18 확장: R09 라이나 실버치아(171) + R14 상해질병_회사미상(410, **다른 회사**).
- **회사 넘어 검색 검증**: R14(새 회사) 필터검색 rerank 0.992 · 전코퍼스 경쟁 rank 3 → 검색은 회사 넘어 버팀.
- **색인 대기 KB 대형 5 PDF**(700~1200p): 추출 OOM은 `-Xmx2g`로 해결(검증), GPU embed로 대형도 실용화. (KB_플러스운전자 파일은 세션 중 파일명 인코딩 꼬임 → 클린 재복사 필요.)
