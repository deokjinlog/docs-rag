...
#
# 값은 실측 분포에서 나왔다(2026-09-04, 부정 4건 vs 긍정 골든 n=25):
#     피자 배달 0.0014 · 반려동물 0.0171 · 자동차 정비 0.1045   ← 주제 부재
#     우주여행 상해 0.2182                                      ← 보험 어휘는 씀(애매)
#     긍정 골든 p10=0.83 · p50=0.96
# 0.1은 "주제 부재"와 "어휘는 겹침"을 가르는 자리다. 0.1~0.3 구간은 어휘갭 후보라
# 재작성 기회를 준다. 코퍼스·임베딩 모델이 바뀌면 분포가 이동하므로 재보정 대상.
